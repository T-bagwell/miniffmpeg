...
#define FFMPEG_CONFIGURATION "--disable-everything --enable-ffprobe --enable-decoder=mpeg2video --enable-demuxer=mpegts --enable-protocol=file --disable-filters --disable-x86asm --disable-sdl2 --enable-muxer=mpegts --enable-encoder=mpeg2video"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 4.8.5 (GCC) 20150623 (Red Hat 4.8.5-28)"
